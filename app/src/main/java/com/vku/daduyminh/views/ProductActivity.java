...
import static com.vku.daduyminh.utils.Constant.CAMERA_PERMISSION_CODE;
import static com.vku.daduyminh.utils.Constant.CATEGORY;
...
import static com.vku.daduyminh.utils.Constant.READ_EXTERNAL_STORAGE_CODE;
...
import static com.vku.daduyminh.utils.ImageUtils.getImageUri;
import static com.vku.daduyminh.utils.ImageUtils.getRealPathFromURI;
...
import com.vku.daduyminh.databinding.ActivityProductBinding;
...
import com.vku.daduyminh.utils.Slide;
import com.vku.daduyminh.viewmodel.HistoryViewModel;
import com.vku.daduyminh.viewmodel.ProductViewModel;
import com.vku.daduyminh.viewmodel.SearchByImageViewModel;
import com.vku.daduyminh.viewmodel.UploadPhotoViewModel;
import com.vku.daduyminh.viewmodel.UserImageViewModel;
...
public class ProductActivity extends AppCompatActivity implements View.OnClickListener, OnNetworkListener, ProductAdapter.ProductAdapterOnClickHandler,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.included.btnImageSearch.setOnClickListener(this);
    ...
    private void getUserImage() {
        userImageViewModel.getUserImage(LoginUtils.getInstance(this).getUserInfo().getId()).observe(this, response -> {
            ...
            if (response != null) {
                ...
                Log.d(TAG, "getUserImage: "+imageUrl);


                Glide.with(getApplicationContext())
                        .load(imageUrl)
                        .placeholder(R.drawable.captaincode)
    ...
    ActivityResultLauncher<Intent> launchSomeActivity
            ...
            result -> {
                if (result.getResultCode()
                    ...
                    Cursor cursor = getContentResolver().query(imageUri,imageProjection,null,null);
                    if(cursor != null){
                        cursor.moveToFirst();
                        ...
                        if(part_image != null)
                        {
                            ...
                            intent.putExtra(KEYWORD,part_image);
                            intent.putExtra("CLASS","searchimage");
                            startActivity(intent);
                        }
                    }
                    }
