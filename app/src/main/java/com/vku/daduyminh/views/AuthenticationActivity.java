...
import static com.vku.daduyminh.R.string.description2;
...
import com.vku.daduyminh.databinding.ActivityAuthenticationBinding;
...
public class AuthenticationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) String formatted = getString(description2, email);
